...
let prizes;
const DEFAULT_MESS = [
  "Tôi nên đoạt giải nhất hay giải nhất, rối ..", // "我是该抽中一等奖还是一等奖呢，纠结ing...",
  "Tôi nghe nói rằng bạn phải ăn chay trước một tháng để trúng số độc đắc!", // "听说要提前一个月吃素才能中大奖喔！",
  "Tôi thực sự muốn giải nhất! ! !", // "好想要一等奖啊！！！",
  "Có ai muốn giải nhất không?", // "一等奖有没有人想要呢？",
  "Giải năm không tệ, miễn là bạn có thể giành được giải thưởng", // "五等奖也不错，只要自己能中奖就行",
  "Chúc các bạn một năm mới An khang thịnh vượng!", // "祝大家新年快乐！",
  "Thắng hay không không quan trọng, mọi người ăn uống no say.", // "中不中奖不重要，大家吃好喝好。",
  "Năm mới, tôi chúc bạn mọi điều tốt đẹp nhất.", // "新年，祝福大家事事顺遂。",
  "Là một chuyên gia đi cùng tôi, tôi sẽ xem có ai trong số các bạn giống tôi không", // "作为专业陪跑的我，我就看看你们有谁跟我一样",
  "Năm mới chúc mọi người ngày càng tốt hơn!", // "新的一年祝福大家越来越好！",
  "Chiến đấu lại vào năm sau !!!", // "来年再战！！！",
];
...
function showPrizeList(currentPrizeIndex) {
  ...
  let htmlCode = `<div class="prize-mess">Đang quay<label id="prizeType" class="prize-shine">${currentPrize.text}</label><label id="prizeText" class="prize-shine">${currentPrize.title}</label>, các giải còn lại<label id="prizeLeft" class="prize-shine">${currentPrize.count}</label></div><ul class="prize-list">`;
  prizes.forEach((item) => {
